      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p
            ...
            style={{ color: 'var(--foreground)' }}
          >
            Here are a few production-grade Flutter apps that highlight my focus on
            resilient architecture, polished UI, and performance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project) => (
            <article
              key={project.title}
              className="rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] backdrop-blur-sm border"
              style={{
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-6" aria-label="Technology tags">
              ...
              <div className="flex flex-wrap gap-4" aria-label="Project links">
                <a
                  ...
                  aria-label={`Watch the demo video for ${project.title}`}
                >
